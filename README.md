...
- Також у проекті дотримувався принципів ООП та вибудував якісну архітектуру.
...
- В тілі циклу
  ...
  - обробка натискання **space**
- Якщо цикл успішно завершився оброблюється **перемога** і повертається значення відносно якого відбувається завершення/перезапуск гри
